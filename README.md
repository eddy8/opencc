...
[![Go](https://github.com/eddy8/opencc/workflows/Go/badge.svg)](https://github.com/eddy8/opencc/actions?query=workflow%3AGo)
...
```sh
go get github.com/eddy8/opencc
```
...
See [benchmark_test.go](https://github.com/eddy8/opencc/tree/master/tests/benchmark_test.go)
